...
# pixel_to_robot maps image→robot with a reflection (negative determinant), so a
# CCW image rotation is a CW robot rotation: ROTATION_SIGN = -1 is what makes the
# assembled pieces interlock (verified in sim_placement against stick.png).
ROTATION_SIGN = -1
